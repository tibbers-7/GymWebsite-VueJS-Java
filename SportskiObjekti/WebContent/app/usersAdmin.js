...
<div >
    <div class="es003">
        <a href="#/ua"><button class="button2" style="margin-left: 70%; margin-top:1%; width:20%; height:7%;">Dodaj novog korisnika</button></a>
    </div>
      ...
      <div class="objectFilter_grid">
        <div class="objFilter1_grid">
            <form>  
                ...
                <option value = "MANAGER" > Menadzer   
                </option>  
                <option value = "CUSTOMER"> Kupac   
                </option>  
                <option value = "TRAINER"> Trener  
                </select>  
            </form> 
        </div>
        <div class="objFilter2_grid">
            <form>  
                ...
                <select class="selectBox"> 
                <option value = "GOLD"> Zlatni   
                </option>  
                <option value = "SILVER"> Srebrni   
                </option>  
                <option value = "BRONZE"> Bronzani   
                </option>  
                </select>  
                </form>  
          </div>
  ...
  <!-- Strelice se ponasaju rtd moram ih namestiti  -->
